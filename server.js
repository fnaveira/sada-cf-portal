...
function seedData() {
  ...
  [
    ...
    [5,"Amistoso vs Carnoedo","Este domingo 23 de agosto a las 10:00 jugamos un amistoso en el Campo del Carnoedo. ¡Todos a animar!","2026-08-23","Partido"]
...
app.put('/api/players/:id', (req, res) => {
  ...
  if (newStatus !== 'disponible') {
    ...
    db.prepare('DELETE FROM convocatoria WHERE playerId = ?').run(pid);
  }
  res.json({ ok: true });
});
