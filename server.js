...
async function initDB() {
  ...
  if (mc.rows[0].c === 0) {
    for (const m of [
      ...
      [10,"C.D. Sigras","2026-11-07",null,"As Mariñas/Carnoedo",1,"Liga","J8",null,"https://www.futbuteo.com/escudos/80/gal-9552526.webp"],
...
async function seedData() {
  ...
  await P(PS, [13,"Bernardo Gómez Cagiao","Bernardo",45,"defensa,centrocampista",47,"no_disponible",0,0,0,"79321949D","1979-05-18","BARRIE DE LA MAZA","639400981","berl2332@hotmail.com","Sada","A Coruña","A Coruña","Española"]);
